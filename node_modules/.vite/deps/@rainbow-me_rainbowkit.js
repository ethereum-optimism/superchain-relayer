import {
  ...
  __spreadArray,
  require_encode_utf8
} from "./chunk-TUJIBF7X.js";
import {
  require_dijkstra
} from "./chunk-7PLA3H2N.js";
import {
  useAccount,
  useBalance,
  useConnect,
  ...
  useSignMessage,
  useSwitchNetwork
} from "./chunk-QVOH2TJL.js";
import "./chunk-WK5ALZ7M.js";
import {
  AddChainError,
  ...
  normalizeChainId,
  require_utils
} from "./chunk-UURKPKYU.js";
import "./chunk-64NFVP37.js";
import {
  mainnet
} from "./chunk-3EFVHQJB.js";
import "./chunk-L3LPOETZ.js";
import {
  init_lib27 as init_lib,
  lib_exports24 as lib_exports
} from "./chunk-YLY6S62E.js";
import "./chunk-SA2S7KCV.js";
...
// node_modules/@rainbow-me/rainbowkit/dist/chunk-O2CXI27D.js
var accentColors = {
...
// node_modules/@rainbow-me/rainbowkit/dist/chunk-FRF2GUPO.js
var darkGrey = "#1A1B1F";
var accentColors2 = {
  blue: { accentColor: "#3898FF", accentColorForeground: "#FFF" },
...
// node_modules/@rainbow-me/rainbowkit/dist/chunk-ATKR4544.js
var accentColors3 = {
...
// node_modules/@rainbow-me/rainbowkit/dist/chunk-GEBDUYT7.js
...
var arbitrumIcon = {
  ...
  iconUrl: async () => (await import("./arbitrum-RJBKFWDE-M676YHJU.js")).default
};
var avalancheIcon = {
  iconBackground: "#e84141",
  iconUrl: async () => (await import("./avalanche-GTODSNSK-BK42DZ6L.js")).default
};
var ethereumIcon = {
  iconBackground: "#484c50",
  iconUrl: async () => (await import("./ethereum-TCZSTHSI-MAQGGYY6.js")).default
};
var hardhatIcon = {
  iconBackground: "#f9f7ec",
  iconUrl: async () => (await import("./hardhat-VJNBZ2P3-WCKC23CZ.js")).default
};
var optimismIcon = {
  iconBackground: "#ff5a57",
  iconUrl: async () => (await import("./optimism-3QUIF6AD-WMJ4FZC6.js")).default
};
var polygonIcon = {
  iconBackground: "#9f71ec",
  iconUrl: async () => (await import("./polygon-JVGMAJ3S-7EAHSNLT.js")).default
};
...
var src = async () => (await import("./assets-7THATBKH-3EYAJTMP.js")).default;
...
var src2 = async () => (await import("./login-EJZTP74Q-US56RAPM.js")).default;
...
var signInIcon = async () => (await import("./sign-3FIRYJVD-5KQEYLK7.js")).default;
...
function ChainModal({ onClose, open }) {
  ...
  const [switchingToChain, setSwitchingToChain] = (0, import_react48.useState)();
  ...
  const stopSwitching = (0, import_react48.useCallback)(() => {
  ...
  return import_react48.default.createElement(Dialog, {
    ...
    return import_react48.default.createElement(import_react48.Fragment, {
    ...
    }, chainIconUrl ? import_react48.default.createElement(Box, {
      height: "full",
      marginRight: "8"
    ...
    })) : null, import_react48.default.createElement("div", null, chain.name)), isCurrentChain && import_react48.default.createElement(Box, {
      alignItems: "center",
      display: "flex",
      flexDirection: "row",
      marginRight: "6"
      ...
      marginLeft: "8",
      width: "8"
    }))))), mobile && idx < (chains == null ? void 0 : chains.length) - 1 && import_react48.default.createElement(Box, {
      background: "generalBorderDim",
      height: "1",
      marginX: "8"
    }));
...
var src3 = async () => (await import("./create-GVGWOEGN-FIIYZZ6N.js")).default;
...
var src4 = async () => (await import("./refresh-J4PXTKTR-BGWW4C27.js")).default;
...
var src5 = async () => (await import("./scan-RESLZYEA-XKSELE33.js")).default;
...
var getBrowserSrc = async () => {
  ...
  switch (browser) {
    case "Chrome":
      return (await import("./Chrome-J3SNM3VC-DOCJXNM3.js")).default;
    case "Brave":
      return (await import("./Brave-AYENFWW6-DJKDPT3U.js")).default;
    case "Edge":
      return (await import("./Edge-L7ZZC477-TJYFS6QJ.js")).default;
    case "Firefox":
      return (await import("./Firefox-JUUNEJSG-EULSQPND.js")).default;
    default:
      return (await import("./Browser-MZYY2QO6-QS6AH4QT.js")).default;
  }
};
...
function GetDetail({
  ...
  return import_react62.default.createElement(Box, {
    ...
    return import_react62.default.createElement(Box, {
      ...
      size: "14",
      weight: "medium"
    }, hasMobileAndExtension ? "Mobile Wallet and Extension" : hasMobileCompanionApp ? "Mobile Wallet" : (downloadUrls == null ? void 0 : downloadUrls.browserExtension) ? "Browser Extension" : null))), import_react62.default.createElement(Box, {
      display: "flex",
      flexDirection: "column",
      gap: "4"
...
function ConnectDetail({
  ...
  return import_react62.default.createElement(Box, {
    ...
    size: "18",
    weight: "bold"
  }, ready ? `Opening ${name}...` : (downloadUrls == null ? void 0 : downloadUrls.browserExtension) ? `${name} is not installed` : `${name} is not available`), !ready && (downloadUrls == null ? void 0 : downloadUrls.browserExtension) ? import_react62.default.createElement(Box, {
    paddingTop: "20"
  }, import_react62.default.createElement(ActionButton, {
...
function DownloadOptionsDetail({
  ...
  return import_react62.default.createElement(Box, {
    ...
    justifyContent: "center",
    width: "full"
  }, import_react62.default.createElement(DownloadOptionsBox, {
...
function useAccountModal() {
  const { openAccountModal } = (0, import_react18.useContext)(ModalContext);
  return { openAccountModal };
}
function useChainModal() {
  const { openChainModal } = (0, import_react18.useContext)(ModalContext);
  return { openChainModal };
}
function useConnectModal() {
  const { openConnectModal } = (0, import_react18.useContext)(ModalContext);
...
var _provider;
var _initUniversalProviderPromise;
var _web3Modal;
var _createWeb3Modal;
var createWeb3Modal_fn;
var _initUniversalProvider;
var initUniversalProvider_fn;
var _createUniversalProvider;
var createUniversalProvider_fn;
var _isChainsAuthorized;
var isChainsAuthorized_fn;
var _switchChain;
var switchChain_fn;
var WalletConnectConnector = class extends Connector {
  constructor(config) {
    ...
    __publicField(this, "onAccountsChanged", (accounts) => {
      if (accounts.length === 0)
        ...
        this.emit("change", { account: (0, import_utils3.getAddress)(accounts[0]) });
    });
  ...
  async connect({ chainId } = {}) {
    ...
    try {
      ...
      const account = (0, import_utils3.getAddress)(accounts[0]);
  ...
  async getProvider({
    ...
    if (this.options.version === "2") {
      ...
      const WalletConnectProvider = (await import("./esm-UG24ARNM.js")).default;
  ...
  async getSigner({ chainId } = {}) {
    ...
    return new lib_exports.Web3Provider(provider_, chainId).getSigner(account);
  }
  async isAuthorized() {
    try {
...
createWeb3Modal_fn = async function() {
  const { Web3Modal } = await import("./dist-PZISHAOK.js");
...
initUniversalProvider_fn = async function() {
  const WalletConnectProvider = (await import("./index.es-OE3GVC3B.js")).default;
...
switchChain_fn = async function(chainId) {
  const provider = await this.getProvider();
  const id = (0, import_utils3.hexValue)(chainId);
  try {
    await Promise.race([
      provider.request({
...
var CoinbaseWalletConnector = class extends Connector {
  constructor({ chains, options }) {
    ...
    __publicField(this, "onAccountsChanged", (accounts) => {
      if (accounts.length === 0)
        ...
        this.emit("change", { account: (0, import_utils4.getAddress)(accounts[0]) });
    });
    __publicField(this, "onChainChanged", (chainId) => {
      const id = normalizeChainId(chainId);
      const unsupported = this.isChainUnsupported(id);
  ...
  async getProvider() {
    var _a;
    if (!__privateGet(this, _provider2)) {
      let CoinbaseWalletSDK = (await import("./dist-PIMJJISA.js")).default;
  ...
  async connect({ chainId } = {}) {
    ...
    try {
      ...
      if (!account) {
        ...
        account = (0, import_utils5.getAddress)(accounts[0]);
      }
      let id = await this.getChainId();
      let unsupported = this.isChainUnsupported(id);
      if (chainId && id !== chainId) {
...
var braveWallet = ({
  ...
  return {
    id: "brave",
    name: "Brave Wallet",
    iconUrl: async () => (await import("./braveWallet-VWIUQB2U-Q3K5SDCB.js")).default,
    iconBackground: "#fff",
...
var coinbaseWallet = ({
  ...
  return {
    ...
    shortName: "Coinbase",
    iconUrl: async () => (await import("./coinbaseWallet-VVDQG4AO-Z5EIMZ4G.js")).default,
    iconAccent: "#2c5ff6",
...
var injectedWallet = ({
  ...
  iconUrl: async () => (await import("./injectedWallet-FYEFRY76-REBXH4P7.js")).default,
  iconBackground: "#fff",
...
var metaMaskWallet = ({
  ...
  return {
    id: "metaMask",
    name: "MetaMask",
    iconUrl: async () => (await import("./metaMaskWallet-F3BDZH5W-O3SA2A7J.js")).default,
    iconAccent: "#f6851a",
    iconBackground: "#fff",
...
var rainbowWallet = ({
  ...
  return {
    id: "rainbow",
    name: "Rainbow",
    iconUrl: async () => (await import("./rainbowWallet-KSMGN6MJ-NG3YGKZE.js")).default,
...
var walletConnectWallet = ({
  ...
  id: "walletConnect",
  name: "WalletConnect",
  iconUrl: async () => (await import("./walletConnectWallet-GTSESN7Q-JIXRH5KY.js")).default,
