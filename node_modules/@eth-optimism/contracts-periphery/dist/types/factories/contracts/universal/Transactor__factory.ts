...
import type {
  Transactor,
  TransactorInterface,
} from "../../../contracts/universal/Transactor";
...
type TransactorConstructorParams =
  | [signer?: Signer]
  | ConstructorParameters<typeof ContractFactory>;

const isSuperArgs = (
  xs: TransactorConstructorParams
): xs is ConstructorParameters<typeof ContractFactory> => xs.length > 1;

export class Transactor__factory extends ContractFactory {
  constructor(...args: TransactorConstructorParams) {
    if (isSuperArgs(args)) {
      super(...args);
    } else {
  ...
  override deploy(
    ...
    return super.deploy(_owner, overrides || {}) as Promise<Transactor>;
  }
  ...
  override attach(address: string): Transactor {
    return super.attach(address) as Transactor;
  }
  override connect(signer: Signer): Transactor__factory {
