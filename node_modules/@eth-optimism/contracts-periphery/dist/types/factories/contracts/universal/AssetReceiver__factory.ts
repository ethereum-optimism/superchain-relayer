...
import type {
  AssetReceiver,
  AssetReceiverInterface,
} from "../../../contracts/universal/AssetReceiver";
...
type AssetReceiverConstructorParams =
  | [signer?: Signer]
  | ConstructorParameters<typeof ContractFactory>;

const isSuperArgs = (
  xs: AssetReceiverConstructorParams
): xs is ConstructorParameters<typeof ContractFactory> => xs.length > 1;

export class AssetReceiver__factory extends ContractFactory {
  constructor(...args: AssetReceiverConstructorParams) {
    if (isSuperArgs(args)) {
      super(...args);
    } else {
  ...
  ): Promise<AssetReceiver> {
    return super.deploy(_owner, overrides || {}) as Promise<AssetReceiver>;
  }
  ...
  override attach(address: string): AssetReceiver {
    return super.attach(address) as AssetReceiver;
  }
  override connect(signer: Signer): AssetReceiver__factory {
    return super.connect(signer) as AssetReceiver__factory;
  }

  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): AssetReceiverInterface {
    return new utils.Interface(_abi) as AssetReceiverInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): AssetReceiver {
    return new Contract(address, _abi, signerOrProvider) as AssetReceiver;
  }
}
