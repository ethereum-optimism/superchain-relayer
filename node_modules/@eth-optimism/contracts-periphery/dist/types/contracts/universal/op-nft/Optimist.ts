...
export interface Optimist extends BaseContract {
  ...
  functions: {
    ...
    ATTESTOR(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    ...
    ATTESTOR(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    ATTESTOR(overrides?: CallOverrides): Promise<PopulatedTransaction>;
