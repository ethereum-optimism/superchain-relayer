...
export interface LegacyMessagePasser_TestInterface extends utils.Interface {
  functions: {
    ...
    "test_passMessageToL1_succeeds()": FunctionFragment;
  };
  ...
  encodeFunctionData(
    functionFragment: "test_passMessageToL1_succeeds",
    values?: undefined
  ): string;
...
export interface LegacyMessagePasser_Test extends BaseContract {
  ...
  callStatic: {
    ...
    test_passMessageToL1_succeeds(overrides?: CallOverrides): Promise<void>;
  };
