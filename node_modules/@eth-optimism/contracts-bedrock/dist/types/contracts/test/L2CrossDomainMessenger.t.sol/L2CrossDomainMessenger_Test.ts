...
export interface L2CrossDomainMessenger_TestInterface extends utils.Interface {
  functions: {
    ...
    "test_pause_notOwner_reverts()": FunctionFragment;
    ...
    "test_relayMessage_retry_succeeds()": FunctionFragment;
    ...
    "test_xDomainSender_senderNotSet_reverts()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "test_pause_notOwner_reverts",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "test_relayMessage_retry_succeeds",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "test_xDomainSender_senderNotSet_reverts",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface L2CrossDomainMessenger_Test extends BaseContract {
  ...
  callStatic: {
    ...
    test_pause_notOwner_reverts(overrides?: CallOverrides): Promise<void>;
    ...
    test_relayMessage_retry_succeeds(overrides?: CallOverrides): Promise<void>;
