...
export interface GasPriceOracle_TestInterface extends utils.Interface {
  functions: {
    ...
    "test_decimals_succeeds()": FunctionFragment;
    "test_gasPrice_succeeds()": FunctionFragment;
    "test_l1BaseFee_succeeds()": FunctionFragment;
    "test_overhead_succeeds()": FunctionFragment;
    "test_scalar_succeeds()": FunctionFragment;
    "test_setGasPrice_doesNotExist_reverts()": FunctionFragment;
    "test_setL1BaseFee_doesNotExist_reverts()": FunctionFragment;
  };
  ...
  encodeFunctionData(
    functionFragment: "test_decimals_succeeds",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_gasPrice_succeeds",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_l1BaseFee_succeeds",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_overhead_succeeds",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_scalar_succeeds",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_setGasPrice_doesNotExist_reverts",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_setL1BaseFee_doesNotExist_reverts",
    values?: undefined
  ): string;
...
export interface GasPriceOracle_Test extends BaseContract {
  ...
  callStatic: {
    ...
    test_decimals_succeeds(overrides?: CallOverrides): Promise<void>;

    test_gasPrice_succeeds(overrides?: CallOverrides): Promise<void>;

    test_l1BaseFee_succeeds(overrides?: CallOverrides): Promise<void>;

    test_overhead_succeeds(overrides?: CallOverrides): Promise<void>;

    test_scalar_succeeds(overrides?: CallOverrides): Promise<void>;
