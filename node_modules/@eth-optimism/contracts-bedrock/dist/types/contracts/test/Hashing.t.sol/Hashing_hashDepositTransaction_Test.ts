...
export interface Hashing_hashDepositTransaction_TestInterface
  ...
  functions: {
    ...
    "testDiff_hashDepositTransaction_succeeds(address,address,uint256,uint256,uint64,bytes,uint256)": FunctionFragment;
  };
  ...
  encodeFunctionData(
    functionFragment: "testDiff_hashDepositTransaction_succeeds",
    values: [
...
export interface Hashing_hashDepositTransaction_Test extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: Hashing_hashDepositTransaction_TestInterface;
