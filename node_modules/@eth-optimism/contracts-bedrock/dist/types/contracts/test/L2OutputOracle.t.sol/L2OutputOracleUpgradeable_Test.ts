...
export interface L2OutputOracleUpgradeable_TestInterface
  ...
  functions: {
    ...
    "test_initValuesOnProxy_succeeds()": FunctionFragment;
    "test_initializeImpl_alreadyInitialized_reverts()": FunctionFragment;
    "test_initializeProxy_alreadyInitialized_reverts()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "test_initValuesOnProxy_succeeds",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_initializeImpl_alreadyInitialized_reverts",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_initializeProxy_alreadyInitialized_reverts",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface L2OutputOracleUpgradeable_Test extends BaseContract {
  ...
  callStatic: {
    ...
    test_initValuesOnProxy_succeeds(overrides?: CallOverrides): Promise<void>;
