...
export interface L2ToL1MessagePasserTestInterface extends utils.Interface {
  functions: {
    ...
    "testFuzz_initiateWithdrawal_succeeds(address,address,uint256,uint256,bytes)": FunctionFragment;
    "test_burn_succeeds()": FunctionFragment;
    "test_initiateWithdrawal_fromContract_succeeds()": FunctionFragment;
    "test_initiateWithdrawal_fromEOA_succeeds()": FunctionFragment;
  };
  ...
  encodeFunctionData(
    functionFragment: "testFuzz_initiateWithdrawal_succeeds",
    values: [
  ...
  encodeFunctionData(
    functionFragment: "test_initiateWithdrawal_fromContract_succeeds",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_initiateWithdrawal_fromEOA_succeeds",
    values?: undefined
  ): string;
