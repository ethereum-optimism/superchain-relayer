...
export interface SystemConfig_GasLimitLowerBound_InvariantInterface
  ...
  functions: {
    ...
    "invariant_gasLimitLowerBound()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "invariant_gasLimitLowerBound",
    values?: undefined
  ): string;
...
export interface SystemConfig_GasLimitLowerBound_Invariant
  extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SystemConfig_GasLimitLowerBound_InvariantInterface;
  ...
  callStatic: {
    ...
    invariant_gasLimitLowerBound(overrides?: CallOverrides): Promise<void>;
