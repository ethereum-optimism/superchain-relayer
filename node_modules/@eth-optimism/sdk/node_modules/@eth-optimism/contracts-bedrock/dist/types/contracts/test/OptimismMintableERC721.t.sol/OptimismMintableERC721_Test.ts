...
export interface OptimismMintableERC721_TestInterface extends utils.Interface {
  functions: {
    ...
    "test_safeMint_notBridge_reverts()": FunctionFragment;
    "test_safeMint_succeeds()": FunctionFragment;
    "test_supportsInterfaces_succeeds()": FunctionFragment;
    "test_tokenURI_succeeds()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "test_safeMint_notBridge_reverts",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_safeMint_succeeds",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_supportsInterfaces_succeeds",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_tokenURI_succeeds",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface OptimismMintableERC721_Test extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: OptimismMintableERC721_TestInterface;
  ...
  callStatic: {
    ...
    test_safeMint_notBridge_reverts(overrides?: CallOverrides): Promise<void>;

    test_safeMint_succeeds(overrides?: CallOverrides): Promise<void>;

    test_supportsInterfaces_succeeds(overrides?: CallOverrides): Promise<void>;

    test_tokenURI_succeeds(overrides?: CallOverrides): Promise<void>;
