...
export interface L2StandardBridge_Bridge_TestInterface extends utils.Interface {
  functions: {
    ...
    "test_finalizeDeposit_depositingERC20_succeeds()": FunctionFragment;
    "test_finalizeDeposit_depositingETH_succeeds()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "test_finalizeDeposit_depositingERC20_succeeds",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_finalizeDeposit_depositingETH_succeeds",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface L2StandardBridge_Bridge_Test extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: L2StandardBridge_Bridge_TestInterface;
