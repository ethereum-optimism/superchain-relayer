...
export interface SequencerFeeVault_TestInterface extends utils.Interface {
  functions: {
    ...
    "test_minWithdrawalAmount_succeeds()": FunctionFragment;
    "test_receive_succeeds()": FunctionFragment;
    "test_withdraw_notEnough_reverts()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "test_minWithdrawalAmount_succeeds",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "test_withdraw_notEnough_reverts",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface SequencerFeeVault_Test extends BaseContract {
  ...
  callStatic: {
    ...
    test_minWithdrawalAmount_succeeds(overrides?: CallOverrides): Promise<void>;

    test_receive_succeeds(overrides?: CallOverrides): Promise<void>;

    test_withdraw_notEnough_reverts(overrides?: CallOverrides): Promise<void>;
