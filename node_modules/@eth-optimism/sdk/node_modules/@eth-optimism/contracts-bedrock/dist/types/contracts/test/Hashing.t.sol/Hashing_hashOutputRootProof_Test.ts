...
export interface Hashing_hashOutputRootProof_TestInterface
  ...
  functions: {
    ...
    "testDiff_hashOutputRootProof_succeeds(bytes32,bytes32,bytes32,bytes32)": FunctionFragment;
  };
  ...
  encodeFunctionData(
    functionFragment: "testDiff_hashOutputRootProof_succeeds",
    values: [
...
export interface Hashing_hashOutputRootProof_Test extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: Hashing_hashOutputRootProof_TestInterface;
