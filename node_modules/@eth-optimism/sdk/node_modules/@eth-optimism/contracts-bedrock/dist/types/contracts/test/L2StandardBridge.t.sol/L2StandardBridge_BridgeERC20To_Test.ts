...
export interface L2StandardBridge_BridgeERC20To_TestInterface
  ...
  functions: {
    ...
    "test_bridgeERC20To_succeeds()": FunctionFragment;
    "test_withdrawTo_withdrawingERC20_succeeds()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "test_bridgeERC20To_succeeds",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_withdrawTo_withdrawingERC20_succeeds",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface L2StandardBridge_BridgeERC20To_Test extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: L2StandardBridge_BridgeERC20To_TestInterface;
  ...
  callStatic: {
    ...
    test_bridgeERC20To_succeeds(overrides?: CallOverrides): Promise<void>;
