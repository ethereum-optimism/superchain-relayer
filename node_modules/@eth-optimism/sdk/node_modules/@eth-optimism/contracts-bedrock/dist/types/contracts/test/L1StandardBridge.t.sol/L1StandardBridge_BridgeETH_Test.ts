...
export interface L1StandardBridge_BridgeETH_TestInterface
  ...
  functions: {
    ...
    "test_bridgeETH_succeeds()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "test_bridgeETH_succeeds",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface L1StandardBridge_BridgeETH_Test extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: L1StandardBridge_BridgeETH_TestInterface;
  ...
  callStatic: {
    ...
    test_bridgeETH_succeeds(overrides?: CallOverrides): Promise<void>;
