...
export interface OptimismMintableERC20_TestInterface extends utils.Interface {
  functions: {
    ...
    "test_bridge_succeeds()": FunctionFragment;
    "test_burn_notBridge_reverts()": FunctionFragment;
    "test_burn_succeeds()": FunctionFragment;
    "test_erc165_supportsInterface_succeeds()": FunctionFragment;
    "test_l1Token_succeeds()": FunctionFragment;
    "test_l2Bridge_succeeds()": FunctionFragment;
    "test_legacy_succeeds()": FunctionFragment;
    "test_mint_notBridge_reverts()": FunctionFragment;
    "test_mint_succeeds()": FunctionFragment;
    "test_remoteToken_succeeds()": FunctionFragment;
    "test_semver_succeeds()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "test_bridge_succeeds",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_burn_notBridge_reverts",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "test_erc165_supportsInterface_succeeds",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_l1Token_succeeds",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_l2Bridge_succeeds",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_legacy_succeeds",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_mint_notBridge_reverts",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_mint_succeeds",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_remoteToken_succeeds",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_semver_succeeds",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface OptimismMintableERC20_Test extends BaseContract {
  ...
  callStatic: {
    ...
    test_bridge_succeeds(overrides?: CallOverrides): Promise<void>;

    test_burn_notBridge_reverts(overrides?: CallOverrides): Promise<void>;
    ...
    test_l1Token_succeeds(overrides?: CallOverrides): Promise<void>;

    test_l2Bridge_succeeds(overrides?: CallOverrides): Promise<void>;

    test_legacy_succeeds(overrides?: CallOverrides): Promise<void>;

    test_mint_notBridge_reverts(overrides?: CallOverrides): Promise<void>;

    test_mint_succeeds(overrides?: CallOverrides): Promise<void>;

    test_remoteToken_succeeds(overrides?: CallOverrides): Promise<void>;

    test_semver_succeeds(overrides?: CallOverrides): Promise<void>;
