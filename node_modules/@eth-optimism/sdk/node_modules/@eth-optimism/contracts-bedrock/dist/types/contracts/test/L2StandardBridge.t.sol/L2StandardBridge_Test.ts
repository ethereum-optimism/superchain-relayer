...
export interface L2StandardBridge_TestInterface extends utils.Interface {
  functions: {
    ...
    "test_withdraw_ether_succeeds()": FunctionFragment;
    "test_withdraw_insufficientValue_reverts()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "test_withdraw_ether_succeeds",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_withdraw_insufficientValue_reverts",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface L2StandardBridge_Test extends BaseContract {
  ...
  callStatic: {
    ...
    test_withdraw_ether_succeeds(overrides?: CallOverrides): Promise<void>;
