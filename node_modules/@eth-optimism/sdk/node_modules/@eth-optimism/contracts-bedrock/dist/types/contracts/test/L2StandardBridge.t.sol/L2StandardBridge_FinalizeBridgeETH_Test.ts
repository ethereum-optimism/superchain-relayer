...
export interface L2StandardBridge_FinalizeBridgeETH_TestInterface
...
export interface L2StandardBridge_FinalizeBridgeETH_Test extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: L2StandardBridge_FinalizeBridgeETH_TestInterface;
