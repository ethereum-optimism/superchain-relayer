...
export interface L1BlockNumberTestInterface extends utils.Interface {
  functions: {
    ...
    "test_getL1BlockNumber_succeeds()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "test_getL1BlockNumber_succeeds",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface L1BlockNumberTest extends BaseContract {
  ...
  callStatic: {
    ...
    test_getL1BlockNumber_succeeds(overrides?: CallOverrides): Promise<void>;
