...
export interface Semver_TestInterface extends utils.Interface {
  functions: {
    ...
    "test_behindProxy_succeeds()": FunctionFragment;
    "test_version_succeeds()": FunctionFragment;
  };
  ...
  encodeFunctionData(
    functionFragment: "test_behindProxy_succeeds",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_version_succeeds",
    values?: undefined
  ): string;
...
export interface Semver_Test extends BaseContract {
  ...
  callStatic: {
    ...
    test_behindProxy_succeeds(overrides?: CallOverrides): Promise<void>;

    test_version_succeeds(overrides?: CallOverrides): Promise<void>;
  };
