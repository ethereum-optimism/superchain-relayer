...
export interface OptimismPortalUpgradeable_TestInterface
  ...
  functions: {
    ...
    "test_initialize_cannotInitImpl_reverts()": FunctionFragment;
    "test_initialize_cannotInitProxy_reverts()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "test_initialize_cannotInitImpl_reverts",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_initialize_cannotInitProxy_reverts",
    values?: undefined
  ): string;
  encodeFunctionData(
