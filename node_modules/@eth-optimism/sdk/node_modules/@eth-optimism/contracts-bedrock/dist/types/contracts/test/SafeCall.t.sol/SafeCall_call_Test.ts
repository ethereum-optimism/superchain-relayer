...
export interface SafeCall_call_TestInterface extends utils.Interface {
  functions: {
...
export interface SafeCall_call_Test extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SafeCall_call_TestInterface;
