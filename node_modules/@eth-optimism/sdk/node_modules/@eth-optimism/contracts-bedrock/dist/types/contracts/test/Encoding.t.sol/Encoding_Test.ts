...
export interface Encoding_TestInterface extends utils.Interface {
  functions: {
    ...
    "testDiff_decodeVersionedNonce_succeeds(uint240,uint16)": FunctionFragment;
    "testDiff_encodeCrossDomainMessage_succeeds(uint240,uint8,address,address,uint256,uint256,bytes)": FunctionFragment;
    "testDiff_encodeDepositTransaction_succeeds(address,address,uint256,uint256,uint64,bool,bytes,uint64)": FunctionFragment;
    "testFuzz_encodeCrossDomainMessageV0_matchesLegacy_succeeds(uint240,address,address,bytes)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "testDiff_decodeVersionedNonce_succeeds",
    values: [PromiseOrValue<BigNumberish>, PromiseOrValue<BigNumberish>]
  ): string;
  encodeFunctionData(
    functionFragment: "testDiff_encodeCrossDomainMessage_succeeds",
    values: [
  ...
  encodeFunctionData(
    functionFragment: "testDiff_encodeDepositTransaction_succeeds",
    values: [
      PromiseOrValue<string>,
      PromiseOrValue<string>,
      PromiseOrValue<BigNumberish>,
  ...
  encodeFunctionData(
    functionFragment: "testFuzz_encodeCrossDomainMessageV0_matchesLegacy_succeeds",
    values: [
      PromiseOrValue<BigNumberish>,
      PromiseOrValue<string>,
      PromiseOrValue<string>,
