...
export interface OptimismPortalResourceFuzz_TestInterface
  ...
  functions: {
    ...
    "testFuzz_systemConfigDeposit_succeeds(uint32,uint8,uint8,uint32,uint32,uint128,uint64,uint64,uint128,uint8)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "testFuzz_systemConfigDeposit_succeeds",
    values: [
...
export interface OptimismPortalResourceFuzz_Test extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: OptimismPortalResourceFuzz_TestInterface;
  ...
  functions: {
    ...
    testFuzz_systemConfigDeposit_succeeds(
      _maxResourceLimit: PromiseOrValue<BigNumberish>,
      _elasticityMultiplier: PromiseOrValue<BigNumberish>,
      _baseFeeMaxChangeDenominator: PromiseOrValue<BigNumberish>,
      _minimumBaseFee: PromiseOrValue<BigNumberish>,
      _systemTxMaxGas: PromiseOrValue<BigNumberish>,
      _maximumBaseFee: PromiseOrValue<BigNumberish>,
