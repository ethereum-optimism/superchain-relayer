...
export interface PreBridgeERC20ToInterface extends utils.Interface {
  functions: {
...
export interface PreBridgeERC20To extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PreBridgeERC20ToInterface;
