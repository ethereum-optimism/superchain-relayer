...
export interface Hashing_InvariantInterface extends utils.Interface {
  functions: {
    ...
    "invariant_hash_xdomain_msg_0()": FunctionFragment;
    "invariant_hash_xdomain_msg_1()": FunctionFragment;
    "invariant_hash_xdomain_msg_high_version()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "invariant_hash_xdomain_msg_0",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "invariant_hash_xdomain_msg_high_version",
    values?: undefined
  ): string;
...
export interface Hashing_Invariant extends BaseContract {
  ...
  callStatic: {
    ...
    invariant_hash_xdomain_msg_0(overrides?: CallOverrides): Promise<void>;
