...
import type {
  LegacyMintableERC20,
  LegacyMintableERC20Interface,
} from "../../../contracts/legacy/LegacyMintableERC20";
...
type LegacyMintableERC20ConstructorParams =
  | [signer?: Signer]
  | ConstructorParameters<typeof ContractFactory>;

const isSuperArgs = (
  xs: LegacyMintableERC20ConstructorParams
): xs is ConstructorParameters<typeof ContractFactory> => xs.length > 1;

export class LegacyMintableERC20__factory extends ContractFactory {
  constructor(...args: LegacyMintableERC20ConstructorParams) {
    if (isSuperArgs(args)) {
      super(...args);
    } else {
  ...
  override deploy(
    ...
    return super.deploy(
      ...
      _symbol,
      overrides || {}
    ) as Promise<LegacyMintableERC20>;
  }
  ...
  override attach(address: string): LegacyMintableERC20 {
    return super.attach(address) as LegacyMintableERC20;
  }
  override connect(signer: Signer): LegacyMintableERC20__factory {
    return super.connect(signer) as LegacyMintableERC20__factory;
  }

  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): LegacyMintableERC20Interface {
    return new utils.Interface(_abi) as LegacyMintableERC20Interface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): LegacyMintableERC20 {
    return new Contract(address, _abi, signerOrProvider) as LegacyMintableERC20;
  }
}
