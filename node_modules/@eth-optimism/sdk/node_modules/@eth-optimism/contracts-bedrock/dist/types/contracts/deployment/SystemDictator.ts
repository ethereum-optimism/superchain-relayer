...
export declare namespace SystemDictator {
  ...
  export type SystemConfigConfigStruct = {
    ...
    resourceConfig: ResourceMetering.ResourceConfigStruct;
  };
  ...
  export type SystemConfigConfigStructOutput = [
    ...
    BigNumber,
    string,
    ResourceMetering.ResourceConfigStructOutput
  ] & {
    owner: string;
    overhead: BigNumber;
    scalar: BigNumber;
    ...
    resourceConfig: ResourceMetering.ResourceConfigStructOutput;
  };
...
export interface SystemDictatorInterface extends utils.Interface {
  functions: {
    ...
    "initialize(((address,address,address,address),(address,address,address,address,address,address,address),(address,address,address,address,address,address,address,address),(address,uint256,uint256,bytes32,uint64,address,(uint32,uint8,uint8,uint32,uint32,uint128))))": FunctionFragment;
    ...
    "phase1()": FunctionFragment;
    "phase2()": FunctionFragment;
  ...
  encodeFunctionData(functionFragment: "phase1", values?: undefined): string;
  encodeFunctionData(functionFragment: "phase2", values?: undefined): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: "phase1", data: BytesLike): Result;
  decodeFunctionResult(functionFragment: "phase2", data: BytesLike): Result;
  decodeFunctionResult(
    functionFragment: "renounceOwnership",
    data: BytesLike
  ): Result;
...
export interface SystemDictator extends BaseContract {
  ...
  callStatic: {
    ...
    phase1(overrides?: CallOverrides): Promise<void>;

    phase2(overrides?: CallOverrides): Promise<void>;
