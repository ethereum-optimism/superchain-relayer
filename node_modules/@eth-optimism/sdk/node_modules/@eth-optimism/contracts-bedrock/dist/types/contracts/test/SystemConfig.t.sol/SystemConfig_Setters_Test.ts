...
export interface SystemConfig_Setters_TestInterface extends utils.Interface {
  functions: {
    ...
    "testFuzz_setUnsafeBlockSigner_succeeds(address)": FunctionFragment;
  };
...
export interface SystemConfig_Setters_Test extends BaseContract {
  ...
  functions: {
    ...
    testFuzz_setBatcherHash_succeeds(
      newBatcherHash: PromiseOrValue<BytesLike>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;

    testFuzz_setGasConfig_succeeds(
      newOverhead: PromiseOrValue<BigNumberish>,
      newScalar: PromiseOrValue<BigNumberish>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
    ...
    testFuzz_setUnsafeBlockSigner_succeeds(
      newUnsafeSigner: PromiseOrValue<string>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
  };
