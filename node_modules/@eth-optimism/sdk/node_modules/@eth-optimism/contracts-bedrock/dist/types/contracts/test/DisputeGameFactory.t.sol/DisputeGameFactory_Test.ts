...
export interface DisputeGameFactory_TestInterface extends utils.Interface {
  functions: {
    ...
    "testDiff_getGameUUID_succeeds(uint8,bytes32,bytes)": FunctionFragment;
    "testFuzz_create_noImpl_reverts(uint8,bytes32,bytes)": FunctionFragment;
    "testFuzz_create_sameUUID_reverts(uint8,bytes32,bytes)": FunctionFragment;
    "testFuzz_create_succeeds(uint8,bytes32,bytes)": FunctionFragment;
...
export interface DisputeGameFactory_Test extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DisputeGameFactory_TestInterface;
