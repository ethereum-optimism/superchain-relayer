...
export interface Hashing_hashWithdrawal_TestInterface extends utils.Interface {
  functions: {
    ...
    "testDiff_hashWithdrawal_succeeds(uint256,address,address,uint256,uint256,bytes)": FunctionFragment;
  };
  ...
  encodeFunctionData(
    functionFragment: "testDiff_hashWithdrawal_succeeds",
    values: [
...
export interface Hashing_hashWithdrawal_Test extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: Hashing_hashWithdrawal_TestInterface;
