...
export interface LegacyERC20ETH_TestInterface extends utils.Interface {
  functions: {
    ...
    "test_approve_doesNotExist_reverts()": FunctionFragment;
    "test_burn_doesNotExist_reverts()": FunctionFragment;
    "test_crossDomain_succeeds()": FunctionFragment;
    "test_decreaseAllowance_doesNotExist_reverts()": FunctionFragment;
    "test_increaseAllowance_doesNotExist_reverts()": FunctionFragment;
    "test_metadata_succeeds()": FunctionFragment;
    "test_mint_doesNotExist_reverts()": FunctionFragment;
    "test_transferFrom_doesNotExist_reverts()": FunctionFragment;
    "test_transfer_doesNotExist_reverts()": FunctionFragment;
  };
  ...
  encodeFunctionData(
    functionFragment: "test_approve_doesNotExist_reverts",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_burn_doesNotExist_reverts",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_crossDomain_succeeds",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_decreaseAllowance_doesNotExist_reverts",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_increaseAllowance_doesNotExist_reverts",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_metadata_succeeds",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_mint_doesNotExist_reverts",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_transferFrom_doesNotExist_reverts",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_transfer_doesNotExist_reverts",
    values?: undefined
  ): string;
...
export interface LegacyERC20ETH_Test extends BaseContract {
  ...
  callStatic: {
    ...
    test_approve_doesNotExist_reverts(overrides?: CallOverrides): Promise<void>;

    test_burn_doesNotExist_reverts(overrides?: CallOverrides): Promise<void>;

    test_crossDomain_succeeds(overrides?: CallOverrides): Promise<void>;
    ...
    test_metadata_succeeds(overrides?: CallOverrides): Promise<void>;

    test_mint_doesNotExist_reverts(overrides?: CallOverrides): Promise<void>;
