...
export interface TestMintableERC721Interface extends utils.Interface {
  functions: {
...
export interface TestMintableERC721 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TestMintableERC721Interface;
