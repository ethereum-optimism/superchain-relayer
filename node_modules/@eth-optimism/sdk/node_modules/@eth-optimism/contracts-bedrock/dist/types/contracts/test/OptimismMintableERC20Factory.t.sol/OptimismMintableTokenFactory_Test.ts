...
export interface OptimismMintableTokenFactory_TestInterface
  ...
  functions: {
    ...
    "test_createStandardL2Token_remoteIsZero_succeeds()": FunctionFragment;
    "test_createStandardL2Token_sameTwice_succeeds()": FunctionFragment;
    "test_createStandardL2Token_succeeds()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "test_createStandardL2Token_remoteIsZero_succeeds",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_createStandardL2Token_sameTwice_succeeds",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_createStandardL2Token_succeeds",
    values?: undefined
  ): string;
  encodeFunctionData(
