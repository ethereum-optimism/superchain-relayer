...
export interface OptimismMintableERC721Factory_TestInterface
  ...
  functions: {
    ...
    "test_createOptimismMintableERC721_succeeds()": FunctionFragment;
    "test_createOptimismMintableERC721_zeroRemoteToken_reverts()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "test_createOptimismMintableERC721_succeeds",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_createOptimismMintableERC721_zeroRemoteToken_reverts",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface OptimismMintableERC721Factory_Test extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: OptimismMintableERC721Factory_TestInterface;
