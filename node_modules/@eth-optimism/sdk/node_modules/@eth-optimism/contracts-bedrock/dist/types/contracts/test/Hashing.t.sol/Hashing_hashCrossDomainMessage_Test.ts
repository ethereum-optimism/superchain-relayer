...
export interface Hashing_hashCrossDomainMessage_TestInterface
  ...
  functions: {
    ...
    "testDiff_hashCrossDomainMessage_succeeds(uint240,uint16,address,address,uint256,uint256,bytes)": FunctionFragment;
    "testFuzz_hashCrossDomainMessageV0_matchesLegacy_succeeds(address,address,bytes,uint256)": FunctionFragment;
  };
  ...
  encodeFunctionData(
    functionFragment: "testDiff_hashCrossDomainMessage_succeeds",
    values: [
  ...
  encodeFunctionData(
    functionFragment: "testFuzz_hashCrossDomainMessageV0_matchesLegacy_succeeds",
    values: [
      PromiseOrValue<string>,
      PromiseOrValue<string>,
      PromiseOrValue<BytesLike>,
...
export interface Hashing_hashCrossDomainMessage_Test extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: Hashing_hashCrossDomainMessage_TestInterface;
