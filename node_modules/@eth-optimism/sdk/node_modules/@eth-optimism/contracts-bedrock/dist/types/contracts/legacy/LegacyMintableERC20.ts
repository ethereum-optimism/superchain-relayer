...
export interface LegacyMintableERC20Interface extends utils.Interface {
  functions: {
...
export interface LegacyMintableERC20 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: LegacyMintableERC20Interface;
