...
export interface FFIInterfaceInterface extends utils.Interface {
  functions: {
    ...
    "getMerkleTrieFuzzCase(string)": FunctionFragment;
    "getProveWithdrawalTransactionInputs((uint256,address,address,uint256,uint256,bytes))": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "getMerkleTrieFuzzCase",
