...
export interface CrossDomainOwnable2_TestInterface extends utils.Interface {
  functions: {
    ...
    "test_onlyOwner_notMessenger_reverts()": FunctionFragment;
    "test_onlyOwner_notOwner2_reverts()": FunctionFragment;
    "test_onlyOwner_notOwner_reverts()": FunctionFragment;
    "test_onlyOwner_succeeds()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "test_onlyOwner_notMessenger_reverts",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_onlyOwner_notOwner2_reverts",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "test_onlyOwner_succeeds",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface CrossDomainOwnable2_Test extends BaseContract {
  ...
  callStatic: {
    ...
    test_onlyOwner_notOwner2_reverts(overrides?: CallOverrides): Promise<void>;

    test_onlyOwner_notOwner_reverts(overrides?: CallOverrides): Promise<void>;

    test_onlyOwner_succeeds(overrides?: CallOverrides): Promise<void>;
