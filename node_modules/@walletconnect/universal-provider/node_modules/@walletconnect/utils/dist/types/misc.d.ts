...
export declare function formatRelayRpcUrl({ protocol, version, relayUrl, sdkVersion, auth, projectId, }: RelayerTypes.RpcUrlParams): string;
...
export declare function createDelayedPromise<T>(expiry?: number | undefined): {
    resolve: (value?: T) => void;
    reject: (value?: ErrorResponse) => void;
    done: () => Promise<T>;
};
export declare function createExpiringPromise<T>(promise: Promise<T>, expiry: number): Promise<unknown>;
